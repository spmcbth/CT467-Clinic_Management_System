                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr>
                                                ...
                                                <td class='button-center'>
                                                    <a href='sua_thuoc.php?id=" . htmlspecialchars($row['MaThuoc']) . "' class='btn btn-warning btn-sm'>
                                                        <i class='fas fa-edit'></i> Sửa
                                                    </a>
                                                    <a href='xoa_thuoc.php?id=" . htmlspecialchars($row['MaThuoc']) . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Bạn có chắc muốn xóa thuốc này không?\");'>
